...
EXCLUDE_PATTERNS = r'(?!izacc)(?!dsc\d+)(?!p\d+)(?!.*\b20\d{6}\b)'

CASIZ_MATCH = rf'{EXCLUDE_PATTERNS}(({CASIZ_PREFIX}{CASIZ_NUMBER_SHORT})|({CASIZ_NUMBER}))'
CASIZ_NUMBER_EXACT = rf'{EXCLUDE_PATTERNS}{CASIZ_PREFIX}([0-9]+)'
